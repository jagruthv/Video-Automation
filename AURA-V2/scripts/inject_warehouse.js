...
db._dbReady.then(() => {
    try {
        db.addWarehouseBlueprint("81c90467543e0503", {
            title: blueprint.title,
            topic: "Nuclear revenge against a family member who stole a wedding fund",
            template: "STANDARD",
            bg_mode: "pinterest",
            blueprint: blueprint,
            stage: 'scripted',
        ...
        console.log("Injected to AURA-V2 warehouse successfully.");
    } catch(e) {
        console.error(e);
    }
});
